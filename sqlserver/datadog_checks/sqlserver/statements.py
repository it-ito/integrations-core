...
with qstats as (
    select query_hash, query_plan_hash, last_execution_time, last_elapsed_time,
            CONCAT(
                ...
                CONVERT(nvarchar(10), statement_start_offset), ',',
                CONVERT(nvarchar(10), statement_end_offset)) as plan_handle_and_offsets,
...
qstats_aggr_split as (select TOP {limit}
    convert(binary(64), substring(plan_handle_and_offsets, 1, first_comma_index - 1), 1) as plan_handle,
